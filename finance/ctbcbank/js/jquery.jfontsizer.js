...
jQuery.fn.jfontsizer = function(o) {
	...
	if (getCookie('fsizer') != "") {
		...
		switch (c) {
			case 'fs_sml':
				s = 'fsactive';
			$(o.applyTo).css('font-size','.'+(9-o.changesmall)+'em');
				break;
			case 'fs_med':
				m = 'fsactive';
			$(o.applyTo).css('font-size','0.8em');
				break;
			case 'fs_lrg':
				l = 'fsactive';
	...
	$(this).html('<span class="fsizer"><a id="fs_lrg" class="'+l+'">A</a><a id="fs_med" class="'+m+'">A</a><a id="fs_sml" class="'+s+'">A</a></span>');
